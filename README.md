...
Smarty/FD1                                ?                               file_delete      __destruct          
...
WordPress/Dompdf/RCE1                     0.8.5+ & WP < 5.5.2             rce              __destruct     *    
WordPress/Dompdf/RCE2                     0.7.0 <= 0.8.4 & WP < 5.5.2     rce              __destruct     *    
WordPress/Guzzle/RCE1                     4.0.0 <= 6.4.1+ & WP < 5.5.2    rce              __toString     *    
WordPress/Guzzle/RCE2                     4.0.0 <= 6.4.1+ & WP < 5.5.2    rce              __destruct     *    
WordPress/P/EmailSubscribers/RCE1         4.0 <= 4.4.7+ & WP < 5.5.2      rce              __destruct     *    
WordPress/P/EverestForms/RCE1             1.0 <= 1.6.7+ & WP < 5.5.2      rce              __destruct     *    
WordPress/P/WooCommerce/RCE1              3.4.0 <= 4.1.0+ & WP < 5.5.2    rce              __destruct     *    
WordPress/P/WooCommerce/RCE2              <= 3.4.0 & WP < 5.5.2           rce              __destruct     *    
WordPress/P/YetAnotherStarsRating/RCE1    ? <= 1.8.6 & WP < 5.5.2         rce              __destruct     *    
Yii/RCE1                                  1.1.20                          rce              __wakeup       *    
Yii2/RCE1                                 <2.0.38                         rce              __destruct     *    
Yii2/RCE2                                 <2.0.38                         rce              __destruct     *    
